    ...
    try {
        ...
        const statsQuery = `
                    SELECT
                        ...
                        COUNT(*) FILTER (WHERE tsf.status = 'Pending' AND tsf.tutor_status = 'Pending') AS pending_assignments,
                        COUNT(DISTINCT tsf.final_assignment_id) AS all_assignments,
