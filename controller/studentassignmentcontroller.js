...
exports.writeassignment = async (req, res) => {
  ...
  if (attempts >= 3) {
    return res.status(400).json({
      statusCode: 400,
      message:
        "Attempt limit reached — you cannot attempt this assignment again",
    });
  }
  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO tbl_student_assignment (student_id,assignment_id,total_marks,attempt_number) VALUES($1,$2,$3,$4) RETURNING *`,
    ...
    for (const a of answers) {
      ...
      await pool.query(
        `INSERT INTO tbl_student_answers (student_assignment_id,question_id,selected_answer,correct_answer,is_correct) VALUES($1,$2,$3,$4,$5)`,
